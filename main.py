...
from src.database.gasto_repository import inserir_gasto, criar_tabela, listar_gastos, excluir_gastos, editar_gastos, filtrar_gastos
...
def main():
    ...
    if decisao == "SIM":
        inicio = input('inicio: ')
        fim = input('fim: ')
        filtrar_gastos(inicio, fim) # Criar a logica de coleta para os filtros
